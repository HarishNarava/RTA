...
# options_road_surface = ['Dry', 'Wet or damp', 'Snow', 'Flood over 3cm. deep']
...
# features = ['Minutes', 'Day_of_week', 'Number_of_vehicles_involved', 'Number_of_casualties', 'Light_conditions',
#             'Driving_experience', 'Road_surface_conditions', 'Types_of_Junction', 'Hour', 'Type_of_collision']
...
#         col1, col2, col3 = st.columns(3)  # Create 3 columns for input widgets
#         with col1:
...
#         with col2:
#             Number_of_casualties = st.slider("Number of Casualties: ", 0, 7, value=0, format="%d")
...
#             Road_surface_conditions = st.selectbox("Select Surface of the Road: ", options=options_road_surface)
...
#         Road_surface_conditions = label_encoder(Road_surface_conditions, options_road_surface)
...
#         data = np.array([Minutes, Day_of_week, Number_of_vehicles_involved, Number_of_casualties, Light_conditions,
#                          Driving_experience, Road_surface_conditions, Types_of_Junction, Hour, Type_of_collision]).reshape(1, -1)
